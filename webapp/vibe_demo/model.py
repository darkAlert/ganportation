...
class VibeModel(object):
    ...
    def run(self):
        for frame in self.connector.frames():
            # self.connector.logger.info("RUN!")
            ...
            text = '{:.3f}/{:.3f}/{:.3f}'.format(data['smpl']['avatar_cam'][0,0], data['smpl']['avatar_cam'][0,1], data['smpl']['avatar_cam'][0,2])
...
if __name__ == '__main__':
    model = VibeModel(2, path_to_conf='/home/darkalert/builds/holoportrt/holoport/conf/local/vibe_conf_local.yaml')
    model.run2()